...
const userConfirmService = ({ id, email_confirm }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield userRepository.update(user.id, Object.assign({}, newUser));
    return newUser;
});
exports.default = userConfirmService;
