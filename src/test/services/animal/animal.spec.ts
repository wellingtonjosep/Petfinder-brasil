...
describe("List all animals", () => {                      
    ...
    test("Should insert the information of new animal in the database", async () => {
      ...
      try {
        ...
        const newAnimal = await animalCreateService(testAnimal.name, testAnimal.breed, testAnimal.species, testAnimal.description, testAnimal.image, testAnimal.lastLocation, testAnimal.lastDate, testAnimal.found, testAnimal.userId);
